...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(75).render("LEVEL SELECTOR", True, "#b68f40")
        MENU_RECT = MENU_TEXT.get_rect(center=(640, 100))

        PLAY_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(640, 250), 
                            text_input="LEVEL 1", font=get_font(45), base_color="#d7fcd4", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(640, 400), 
                            text_input="LEVEL 2", font=get_font(45), base_color="#d7fcd4", hovering_color="White")
